...
\only<1>{\qquad Bug fixing\\ \includegraphics[height=4cm]{images/bugfixing}}
\only<2>{\quad Improve Drawer\\ \includegraphics[height=4cm]{images/drawer}}
...
\begin{columns}
\begin{column}{0.5\textwidth}
\only<1,2>{\includegraphics[height=3.5cm]{../report/figures/pres/Screenshot_2014-05-12-21-30-05}}
\only<3>{\quad \includegraphics[height=3.5cm]{images/thumbs}}
\end{column}
\begin{column}{0.5\textwidth}

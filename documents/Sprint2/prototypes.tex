...
At the end of first sprint, the existing features of \launcher were polished and the project would only need to be kept updated with the implementation of the new database.
...
The second option is more centred on making the settings screen streamlined across applications and would thus be a operative project with the \textit{GIRAF Components} group.
...
\centering
    ...
    \caption{An example of information about a user seen in the drawer.}

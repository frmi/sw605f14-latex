...
The idea to add settings management to all \giraf applications was of high priority to the group, since it would determine the future development of \launcher.\thilemann{Need a way to access settings in giraf}

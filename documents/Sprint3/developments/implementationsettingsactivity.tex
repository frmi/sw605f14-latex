...
The overall purpose of \lstinline|SettingsActivity| is illustrated in \cref{fig:settingsarchitecture}.
As seen in the figure it contains various components.
This makes its main responsibility responding to updates in these components, and inflating their layouts, as seen in \cref{lst:settingsactivity:layout}.
...
\thilemann{Extract the appropriate parts from the contents below and put it here.}

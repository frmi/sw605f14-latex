...
The most interesting of the two preferences is the icon scaling, since ``Show start up animation" is created with a standard Android preference component, providing the layout with a two-state switch.\thilemann{Sounds weird to interduce sharedpreference with ``of the two preference'' since the reader has no clue what these preferences are.}

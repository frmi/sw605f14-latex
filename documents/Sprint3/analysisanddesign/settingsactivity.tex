...
\Cref{fig:settingsarchitecture} presents the visual design and the components it will consist of, which is further explained in the list below:

\begin{itemize}
\item \textbf{Settings Activity} is the logical container for the layout of settings.
\item \textbf{Settings List Fragment} is responsible for selection, namely profiles and what settings to display for the 

...
\thilemann{Write about this design us typically used in applications running on tablet devices, and find out a way to say why this is a smart way to do it :)}

\paragraph{Settings List Fragment}


\begin{itemize}
\item \textbf{Profile Selector} 
\item \textbf{ListView}
\end{itemize}

\paragraph{Settings Container Fragment}


%\begin{itemize}
%\item \textbf{Settings Activity} is the logical container for the layout of settings.
%
%
%It is therefore also the entity used to communicate between the fragments.
%
%\item \textbf{Settings List Fragment} is responsible for selection, namely profiles and what settings to display for the selected user.
%It will further contain the following components:
%\begin{itemize}
%\item \textbf{Profile Selector}
%\item \textbf{ListView}
%\end{itemize}
%\item \textbf{Settings Container Fragment}\\
%text
%\end{itemize}

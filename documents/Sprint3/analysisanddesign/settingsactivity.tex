...
\subsubsection{\launcher Settings}\label{sec:launchersettings}
...
\begin{itemize}
\item \textbf{\launcer settings}\\
Since no critical settings are needed for \launcer, it will contain the settings presented in the prototypes apart from the ability of changing colors for an application.
\thilemann{Add reference to where we write about the misinterpretation of adding colors to apps}

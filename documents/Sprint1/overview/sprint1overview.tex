...
We have selected the to work with the \launcher application, which is further described in \cref{sec:launcher}.\thilemann{Where to say that we only are working on launcher. Removed it from this section, since it was not consistent with other text.}
...
This event failed due to the unstructured nature of the setup of the environment (Eclipse IDE and ANT build system), and thus not every student was able to get \giraf to work.\thilemann{This sentence much - what is unstructured nature of the setup?}
\end{itemize}

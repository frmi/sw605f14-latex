\subsection{Functional Tests}\label{sec:testing_sprint1}
...
\thilemann[inline]{Please consider rewriting to present tense - yes/no?}

We only describe the results we find the most interesting in this section; mainly tests that failed in a significant way. \jesper{Should we have a test appendix with the full results?}\vagner{I think so.}\thilemann{A yes that is...}
...
\begin{itemize}
	...
	\item \textit{Only display application names if the user is able to read.}\thilemann{What does this mean?}
\end{itemize}
\end{quote}
...
\thilemann{Add description of the actual tests are found in the developments section.}
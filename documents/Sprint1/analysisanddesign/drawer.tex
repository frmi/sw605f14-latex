...
These widgets are a part of \textit{Giraf Components}, as described in \cref{sec:giraf:applications}.
...
The drawer opens by pressing and holding the handle (indentation) of the sidebar (see \cref{fig:drawerclosed}) while sliding it to the right.

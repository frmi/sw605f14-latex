...
The implementations of these widgets are a part of \textit{Giraf Components}, a separate project in the \giraf system that handles customized Graphical User Interface components.\thilemann{We have already said this?}
It should be utilized throughout all \giraf applications to make them look and feel the same.\thilemann{Same here.}
...
\thilemann[inline]{Jesper: Introduce new namings :)}

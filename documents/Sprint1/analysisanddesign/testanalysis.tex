...
We only describe the results we find the most interesting in this section; mainly tests that failed in a significant way. \jesper{Should we have a test appendix with the full results?}\vagner{I think so.}\thilemann{A yes that is...}\vagner{Lets answer eachothers comments with MOAR COMMENTS!}

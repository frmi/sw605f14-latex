...
The activity loads the user information from the database, and proceeds to Home activity.
...
The Home activity for a test guardian user is seen in \cref{fig:launcheractivity:home} with the user's installed \giraf applicatons.

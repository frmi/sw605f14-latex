...
\thilemann[inline]{Short note on what an activity is.}
...
\citet{launcher2012} describes how user identification is necessary, as the \giraf settings must be able to vary from user to user.\thilemann{Is it really because of settings we are using stupid authentication?} 
...
Finally, there is a colour palette hidden in a drawer component, where the user can change the base colour of each installed application.\thilemann{But not all?} 

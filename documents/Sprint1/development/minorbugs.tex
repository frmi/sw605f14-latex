...
The issue was resolved by overlaying a shape with the corners rounded and a transparent center on the Listview.\vagner{I'm not sure that we still do this, since it was fixed by the GUI group just before sprint 1 end... but since it was only fixed by the very end should we still include it?}

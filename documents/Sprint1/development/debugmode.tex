\subsection{Debug Mode for Launcher}\vagner{Do we plan on getting this to work? Since it doesnt work in Sprint 2 at all?}
...
\thilemann{We should add a sequence diagram}
\thilemann{Maybe also a class diagram to give an overview?}
\vagner{I say yes for sequence diagram and no for class diagram. However, we are running out of space}
...
\end{lstlisting}
So...\vagner{finish this subsection!}
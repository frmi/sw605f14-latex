...
\paragraph{Specification:} The device buttons (\textit{Back}, \textit{Home}, and \textit{Multitasking}) should have no effect in the \mainactivity and \authenticationactivity, as the user should not be able to ``back out'' of \launcher to the device OS.\thilemann{Only relevant when not set as default launcher?}
...
\thilemann[inline]{Check present tense throughout functional test} 

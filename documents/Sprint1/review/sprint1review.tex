...
At our meeting, the Scrum master of the \giraf project started with a short presentation, and then gave the floor to the groups.\jesper{Describe the context of the \giraf project early in the report.}\vagner{What does that comment even mean?} 
They spent five minutes each demonstrating their progress to the stakeholders\jesper{In aforementioned context description, define the stakeholders of the \giraf project}. 
...
It was decided to, at a later date, discuss the possibility of designate another person as responsible for conducting the sprint review meeting, and possibly the sprint planning meetings as well. \vagner{Maybe mention that Jesper actually picked up that cup?}

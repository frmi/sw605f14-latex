...
Since we were not able to get any feedback on our progress with \launcher, and there, in our opinion, was little more to do to improve on the existing features, we could not immediately continue development on the next sprint. As described in \cref{sec:sprint2:overview}, we would have to explorer whether the clients had further requirements for \launcher. 
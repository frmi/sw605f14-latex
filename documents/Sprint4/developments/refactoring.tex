...
The two new classes have their own specific purposes, while \lstinline|LauncherUtility| handles a collection of smaller purposes.\frederik{Skriv i diskussionen hvordan disse utility klasser kan formindskes, vha. f.eks. ved brug af et app layout.}
...
\item When having loaded applications in \lstinline|GirafFragment| and \lstinline|AndroidFragment| once, selecting the panes subsequently does not cause the fragment to reload applications. This is a hugh optimization.\frederik{Vagner siger at dette er Frederiks afsnit, da han har lavet koden og ved hvad den gør}
\end{itemize}

\subsection{LoadApplicationTask}\label{sec:sprint4:dev:loadapplicationtask}\vagner{I dont like that in this section that is supposedly about SettingsActivity, we are writting things about HomeActivity.}

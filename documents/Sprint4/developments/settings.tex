...
Once \lstinline!doinBackground()! finishes, \lstinline!onPostExecute()! then adds the application to the target view. 
 ...
 All of the three methods are overridden and call \lstinline!super.FooBar()!, thus executing all the work done by the superclass.\frederik{Det her lugter så åndssvagt meget af at man godt ville kunne merge dem. Jeg kan ikke helt huske den præcise tekniske grund for at vi ikke kunne, så dette skal måske rettes i.}

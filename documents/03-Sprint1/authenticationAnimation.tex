...
The original \lstinline{AnimationDrawable} was set up as shown in \Cref{lst:animationDrawable}\jesper{Fix this ref problem.}. \lstinline{R.animator.instruct_ani} is a list of images combined with a constant for each image, which determines the duration each image should be shown.

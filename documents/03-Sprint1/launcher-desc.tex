...
The control committee\jesper{Hvad kalder vi status gruppen?} of the multi-project decided that the focus of the first sprint should be on debugging, and as Launcher was a relatively complete, but was reported as unreliable, we decided was an obvious focus for debugging sprint. 
...
\section{Launcher Functionality}

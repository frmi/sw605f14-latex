...
Most importantly being the ``citizens", which are the ones utilizing the capabilities of each application, where citizen refers to either a child or an adult person diagnosed with ASD.\thilemann{Repetition of something said earlier. Should it only be mentioned one place? Think it flows well here and fits whats comming next.}

This appendix descipes the implementation of a debug mode, making developers able to skip certain steps in the launcher, such as the animation screen and the authentication screen.\\

...
Since multiple project groups are collaborating towards developing a complete system, it is specified by the multi-project guidelines that the groups must work in four sprints.\vagner{Omskriv dette til ikke tale om guidelines.}

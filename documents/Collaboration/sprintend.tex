As we are using the Scrum method of development for the entire \giraf project, a sprint review was planned for the end of each iteration. 
...
\subsection{The Second Sprint Review}
